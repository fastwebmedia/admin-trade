<?php namespace FWM\Admin\Commands;
...
class InstallCommand extends Command
{
	...
	public function fire()
	{
		...
		$this->call('vendor:publish', ['--provider' => 'FWM\Admin\AdminServiceProvider']);
	...
	protected function publishDB()
	{
		...
		$this->call('db:seed', [
			'--class' => 'FWM\\AdminAuth\\Database\\Seeders\\AdministratorsTableSeeder'
		]);
	}
	...
	protected function publishConfig($title = null)
	{
		...
		if ( ! is_null($title))
		{
			...
			$contents = str_replace('Administrator', $title, $contents);
			$this->laravel['files']->put($file, $contents);
		}
	}
