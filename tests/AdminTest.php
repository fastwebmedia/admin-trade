...
class AdminTest extends TestBase
{
	...
	{
		$this->assertInstanceOf('FWM\Admin\Admin', Admin::instance());
	}
	...
	public function it_creates_model_configuration()
	{
		...
		$this->assertInstanceOf('FWM\Admin\Model\ModelConfiguration', $model);
	}
	...
	public function it_provides_registered_models()
	{
		...
		$this->assertInstanceOf('FWM\Admin\Model\ModelConfiguration', $models['Foo\Bar\Model']);
	}
	...
	public function it_provides_current_template_instance()
	{
		...
		$this->assertInstanceOf('FWM\Admin\Templates\TemplateDefault', $template);
	}
	...
	public function it_creates_menu_item()
	{
		...
		$this->assertInstanceOf('FWM\Admin\Menu\MenuItem', $menu);
	}
	...
	public function it_provides_root_menu_items()
	{
		...
		$this->assertContainsOnlyInstancesOf('FWM\Admin\Menu\MenuItem', $items);
	}
